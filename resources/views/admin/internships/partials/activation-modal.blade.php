<div x-data="{ show: false, id: null, name: '' }" 
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div x-show="show" 
             class="inline-block align-bottom bg-white dark:bg-slate-900 rounded-2xl text-left overflow-visible shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full border border-transparent dark:border-slate-800">
            
            <form :action="'{{ route('admin.internships.activate', 'PLACEHOLDER_ID') }}'.replace('PLACEHOLDER_ID', id)" method="POST">
                @csrf
                @method('PATCH')
                
                <div class="bg-white dark:bg-slate-900 rounded-t-2xl px-6 pt-6 pb-4 sm:p-8 sm:pb-6 transition-colors duration-300">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            <div class="mt-2 text-sm text-slate-500 dark:text-slate-400 space-y-4 transition-colors">
                                ...
                                <div class="space-y-6 border-t border-slate-100 dark:border-slate-800 pt-6 mt-6 transition-colors flex flex-col relative">
                                        ...
                                        <div class="space-y-1.5 relative z-50">
                                            ...
                                            <div class="relative">
                                                <input type="text" name="induction_date" id="induction_date" required placeholder="Pilih Tanggal..."
                                                    x-init="flatpickr($el, { static: true, dateFormat: 'Y-m-d', altInput: true, altFormat: 'd/m/Y', locale: 'id', disableMobile: true })"
                                        ...
                                        <div class="space-y-1.5 relative z-50">
                                            ...
                                            <div class="relative">
                                                <input type="text" name="induction_time" id="induction_time" required placeholder="Pilih Jam..."
                                                    x-init="flatpickr($el, { static: true, enableTime: true, noCalendar: true, dateFormat: 'H:i', time_24hr: true, altInput: true, altFormat: 'H:i', disableMobile: true, minTime: '01:01', maxTime: '23:59' })"
                                                    class="w-full px-4 py-2.5 rounded-xl border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 focus:border-red-500 focus:ring-red-500 text-sm font-bold transition-all pl-10 cursor-pointer">
                                                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
