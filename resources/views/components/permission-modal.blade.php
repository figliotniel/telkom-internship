                ...
                <div class="px-8 py-8 bg-slate-50 dark:bg-slate-900/50 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {{-- Start Time Box --}}
                            <div class="bg-white dark:bg-slate-800 rounded-3xl p-5 shadow-sm border border-slate-100 dark:border-slate-700 relative">
                                ...
                                <div class="flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-6 h-6 text-slate-300 dark:text-slate-600">
                                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <input type="text" name="start_time" id="start_time" 
                                        class="block w-full bg-transparent border-0 focus:ring-0 text-slate-800 dark:text-slate-200 font-black text-3xl placeholder-slate-300 p-0"
