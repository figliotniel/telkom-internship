...
<body class="antialiased bg-white text-slate-800 transition-colors duration-300">

    <!-- Navbar -->
    <nav x-data="{ open: false }" class="sticky top-0 inset-x-0 z-[999] bg-white/95 backdrop-blur-xl border-b border-gray-100 shadow-[0_4px_20px_rgb(0,0,0,0.03)] transition-colors duration-300 py-3">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center min-h-[100px] transition-all duration-300">
                ...
                <div class="hidden md:flex items-center gap-2">
                    <a href="#internship" class="px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Internship</a>
                    <a href="#berita" class="px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Berita</a>
                    <a href="#benefit" class="px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Benefit</a>
                    <a href="#aboutUs" class="px-5 py-2.5 rounded-full text-[15px] font-semibold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">About Us</a>
                </div>
                ...
                <div class="hidden sm:flex items-center gap-4">
                     @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="px-6 py-3 rounded-full text-[15px] font-bold bg-red-600 text-white hover:bg-red-700 transition-colors shadow-lg shadow-red-600/20">Dashboard</a>
                        @else
                            <a href="{{ route('login') }}" class="flex items-center gap-2.5 px-6 py-2.5 rounded-full border-2 border-gray-200 text-gray-600 hover:text-red-600 hover:border-red-600 hover:bg-white transition-all text-[13px] font-bold uppercase tracking-wider">
                                Login 
    ...
    <!-- Berita Section -->
    <section id="berita" class="scroll-mt-32 py-24 bg-white transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-center text-4xl font-black text-slate-900 mb-16 tracking-tight" data-aos="fade-up">Berita Terbaru</h2>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- News Item 1 -->
                <div class="group cursor-pointer" data-aos="fade-up" data-aos-delay="100">
                    <div class="rounded-[2.5rem] overflow-hidden shadow-xl shadow-slate-200/50 h-full bg-white border border-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/10 active:scale-[0.98]">
                        <img src="{{ asset('images/gallery-01.jpg') }}" alt="Briskwalk" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="p-8">
                             <!-- Example Date/Title overlay style from screenshot not exactly replicated but adapted -->
                            <h3 class="text-xl font-black text-orange-500 mb-3 uppercase tracking-wider">Audit Eksternal IMS</h3>
                            <p class="text-slate-600 font-medium leading-relaxed">Witel Semarang Jateng Utara sukses melaksanakan Audit Eksternal IMS 2025 di STO Gombel dan neuCentrIX Candi. Kegiatan ini bertujuan memastikan sistem keamanan dan tata kelola operasional telah memenuhi standar internasional.</p>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="group cursor-pointer" data-aos="fade-up" data-aos-delay="200">
                    <div class="rounded-[2.5rem] overflow-hidden shadow-xl shadow-slate-200/50 h-full bg-white border border-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/10 active:scale-[0.98]">
                        <img src="{{ asset('images/gallery-14.jpg') }}" alt="Innovation" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="p-8">
                            <h3 class="text-xl font-black text-blue-500 mb-3 uppercase tracking-wider">Peresmian Bedah Rumah</h3>
                            <p class="text-slate-600 font-medium leading-relaxed">Sebagai bentuk kepedulian sosial, P2TEL bersama Telkom melaksanakan agenda peresmian program Bedah Rumah. Kegiatan ini bertujuan untuk memberikan hunian yang lebih layak bagi penerima manfaat.</p>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="group cursor-pointer" data-aos="fade-up" data-aos-delay="300">
                    <div class="rounded-[2.5rem] overflow-hidden shadow-xl shadow-slate-200/50 h-full bg-white border border-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-red-500/10 active:scale-[0.98]">
                        <img src="{{ asset('images/gallery-10.jpg') }}" alt="Pengajian" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-105">
                        <div class="p-8">
                            <h3 class="text-xl font-black text-slate-800 mb-3 uppercase tracking-wider">Bantuan Sarana Air Bersih</h3>
                            <p class="text-slate-600 font-medium leading-relaxed">Wujud nyata kepedulian sosial diwujudkan melalui penyerahan bantuan sarana air bersih bagi warga Desa Sidokumpul. Program ini diharapkan dapat mempermudah akses air bersih bagi masyarakat.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Benefit Section -->
    <section id="benefit" class="scroll-mt-32 py-24 bg-slate-50 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <section class="py-24 bg-white transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-4xl font-black text-slate-900 mb-16 tracking-tight" data-aos="fade-up">Their Stories, Their Experience</h2>
            
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <!-- Person 1 -->
                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 shadow-sm" data-aos="flip-left" data-aos-delay="100">
                     <div class="w-20 h-20 rounded-full bg-slate-200 mx-auto mb-6 flex items-center justify-center border-4 border-white shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-slate-400">
                          <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd" />
                        </svg>
                     </div>
                     <h3 class="font-black text-red-600 tracking-wide uppercase text-sm">Lorem Ipsum</h3>
                     <p class="text-xs text-slate-500 mt-4 leading-relaxed italic font-medium">"Enak dan seru magang di Witel Semarang Jateng Utara mendapatkan banyak pengalaman berharga."</p>
                </div>
                <!-- Person 2 -->
                <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 shadow-sm" data-aos="flip-left" data-aos-delay="200">
                    <div class="w-20 h-20 rounded-full bg-slate-200 mx-auto mb-6 flex items-center justify-center border-4 border-white shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-slate-400">
                          <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <h3 class="font-black text-red-600 tracking-wide uppercase text-sm">Lorem Ipsum</h3>
                    <p class="text-xs text-slate-500 mt-4 leading-relaxed italic font-medium">"Program magang di Witel Semarang Jateng Utara memberikan pengalaman yang sangat bermanfaat."</p>
               </div>
               <!-- Person 3 -->
               <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 shadow-sm" data-aos="flip-left" data-aos-delay="300">
                    <div class="w-20 h-20 rounded-full bg-slate-200 mx-auto mb-6 flex items-center justify-center border-4 border-white shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-slate-400">
                          <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <h3 class="font-black text-red-600 tracking-wide uppercase text-sm">Lorem Ipsum</h3>
                    <p class="text-xs text-slate-500 mt-4 leading-relaxed italic font-medium">"Sangat bangga menjadi keluarga besar Telkom khususnya Witel Semarang Jateng Utara."</p>
               </div>
               <!-- Person 4 -->
               <div class="bg-slate-50 p-8 rounded-3xl border border-slate-100 transition-all duration-300 hover:-translate-y-1 shadow-sm" data-aos="flip-left" data-aos-delay="400">
                    <div class="w-20 h-20 rounded-full bg-slate-200 mx-auto mb-6 flex items-center justify-center border-4 border-white shadow-lg">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-12 h-12 text-slate-400">
                          <path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd" />
                        </svg>
                    ...
                    <h3 class="font-black text-red-600 tracking-wide uppercase text-sm">Lorem Ipsum</h3>
                    <p class="text-xs text-slate-500 mt-4 leading-relaxed italic font-medium">"Magang di Witel Semarang Jateng Utara memberikan saya wawasan baru tentang telekomunikasi."</p>
               </div>
            </div>
        </div>
    </section>
