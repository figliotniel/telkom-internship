            ...
            <div class="flex justify-between items-center min-h-[100px] transition-all duration-300">
                ...
                <div class="shrink-0 flex items-center gap-4">
                    <a href="#" class="flex items-center gap-3 group">
                       <img src="{{ asset('images/logo-telkom.png') }}" class="h-[80px] w-auto" alt="Telkom Indonesia">
                    </a>
                </div>

                <!-- Center: Navigation Links -->
                <div class="hidden md:flex items-center gap-2">
                    <a href="#internship" class="px-5 py-2.5 rounded-full text-[16px] font-bold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Internship</a>
                    <a href="#berita" class="px-5 py-2.5 rounded-full text-[16px] font-bold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Berita</a>
                    <a href="#benefit" class="px-5 py-2.5 rounded-full text-[16px] font-bold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">Benefit</a>
                    <a href="#aboutUs" class="px-5 py-2.5 rounded-full text-[16px] font-bold transition-all duration-300 text-gray-500 hover:text-red-600 hover:bg-gray-50">About Us</a>
                </div>
