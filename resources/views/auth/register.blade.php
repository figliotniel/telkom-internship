                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                <x-text-input id="email" class="block w-full bg-gray-50 focus:bg-white transition" 
                                    x-bind:class="{'border-red-500 ring-red-500 focus:border-red-500 focus:ring-red-500': errors.email}" 
